...
public interface PlanVisitorMapper {
    @Select("select * from t_planVisitor where plan_visitor_name = #{param1} and plan_visitor_flag = 0")
    ...
    @Update("update t_planVisitor set plan_visitor_count = plan_visitor_count + 1 where plan_visitor_name = #{param2} and plan_visitor_flag = 0")
